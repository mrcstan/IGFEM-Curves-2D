...
function lhs = design_param_latin_hypercube_sampling(outFile,...
                                                     inputFile,...
                                                     polygonFile,...
                                                     nSamples, ...
                                                     maxTrials,...
        ...
        for j = 1:nSamples
            ...
            try     
                if (any(nlconfun(del,designParams,restrictedParams,channels,nlcon) > 0))
                    ...
                    figure
                    plot_channel_polygons(channels.polygons,channels.vertexCoords,...
                                          designParams.vertices2params,[],false)
                    %}
                end       
            catch err
