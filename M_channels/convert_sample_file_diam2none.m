...
nDiamParams = nnz(strcmpi(designParams.type,'DIAM'));

inputFile = 'parallelStephen_w_diams_b.rand'; 
...
[fileName,pathName] = uiputfile({'*.lhs';'*.rand'},'Save as');
