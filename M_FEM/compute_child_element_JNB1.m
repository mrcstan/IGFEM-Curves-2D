...
%   iCENP: indices of the enrichment node of the child element in the parent
%   element
...
%   B:
%   rPhy:
function [detJ,N,B,rPhy]=compute_child_element_JNB(nurbsSurf,dnurbsSurf,...
